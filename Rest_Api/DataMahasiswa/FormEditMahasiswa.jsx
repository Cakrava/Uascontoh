...
export default function FormEdit({route}) {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setNamaLengkap(json.nama_lengkap_2010008);
        setJenisKelamin(json.jenis_kelamin_2010008);
        setTempatLahir(json.tmp_lahir_2010008);
        setTanggalLahir(new Date(json.tgl_lahir_2010008));
        setAlamat(json.alamat_2010008);
        setNoTelp(json.notelp_2010008);
      } catch (error) {
  ...
  const submitForm = async () => {
    ...
    const formData = {
      alamat_2010008,
      alamat_2010008,
      nama_lengkap_2010008: namaLengkap,
      jenis_kelamin_2010008: jenisKelamin,
      tmp_lahir_2010008: tempatLahir,
      tgl_lahir_2010008: tanggalLahir.toISOString().split('T')[0], // Format to YYYY-MM-DD
      notelp_2010008: noTelp,
      _method: 'PUT',
    };
  ...
  return (
    <ScrollView
      ...
      <Input
        ...
        errorMessage={validationErrors.nama_lengkap_2010008}
      />
      ...
      <Input
        ...
        inputContainerStyle={styles.inputContainer}
        inputStyle={styles.inputText}
        errorMessage={validationErrors.tmp_lahir_2010008}
      />
      ...
      <Input
        ...
        inputContainerStyle={styles.inputContainer}
        inputStyle={styles.inputText}
        errorMessage={validationErrors.alamat_2010008}
      />
      ...
      <Input
        ...
        inputContainerStyle={styles.inputContainer}
        inputStyle={styles.inputText}
        errorMessage={validationErrors.notelp_2010008}
