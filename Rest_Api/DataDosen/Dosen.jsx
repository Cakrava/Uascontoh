...
export default function Dosen() {
  ...
  const renderItemDosen = ({item}) => {
    const showDetailDosen = () => {
      navigation.navigate('DetailDosen', {nidn2010008: item.nidn2010008});
    };
    return (
      <TouchableOpacity style={styles.item} onPress={showDetailDosen}>
        <Text style={styles.titleNidn}>{item.namalengkap2010008}</Text>
        <Text style={styles.text}>{item.nidn2010008}</Text>
